...
@RestController
@RequestMapping("/api/face-recog-kafka")
public class FaceRecogKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FaceRecogKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FaceRecogKafkaResource(KafkaProperties kafkaProperties) {
